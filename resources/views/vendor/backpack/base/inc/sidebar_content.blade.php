...
<li><a href="{{ backpack_url('monster') }}"><i class="fa fa-optin-monster"></i> <span>Profile</span></a></li>
...
{{--{{dd(backpack_user()->hasRole('students'))}}--}}
...
<li class="treeview">
    <a href="#"><i class="fa fa-group"></i> <span>Users, Roles</span> <i
