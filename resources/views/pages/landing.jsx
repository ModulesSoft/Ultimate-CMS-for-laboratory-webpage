                        ...
                        <div className="w3-light-grey w3-padding w3-margin w3-round-large">
                            <article>
                                ...
                                <p className="w3-text-dark-grey">
                                    ...
                                    Similique corrupti aperiam minus suscipit
                                    quis cumque tenetur aliquid et dignissimos.
                                </p>
                            </article>
                            <button className="w3-button w3-block w3-teal w3-round">
                                more
                ...
                <div className="w3-cell w3-mobile w3-light-grey w3-card-4 w3-padding w3-round">
                    ...
                    <article>
                        ...
                        <p className="w3-text-grey">
                            ...
                            elit. Nisi, quisquam est. Optio earum, veniam quod
                            facere saepe eum necessitatibus dolore rerum minus.
                        </p>
                    </article>
                </div>
                <div className="w3-cell w3-mobile w3-light-grey w3-card-4 w3-padding w3-round">
                    ...
                    <article>
                        ...
                        <p className="w3-text-grey">
                            Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Unde nulla qui fuga molestias eius provident,
                            eos, voluptates consequatur magni ipsam quos a
                            maiore
                        </p>
                    </article>
                </div>
