...
/* harmony import */ var _pages_Contact__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pages/Contact */ "./resources/js/components/pages/Contact.vue");
...
/* harmony import */ var _pages_Footerr__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pages/Footerr */ "./resources/js/components/pages/Footerr.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    Footerr: _pages_Footerr__WEBPACK_IMPORTED_MODULE_4__["default"],
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios.get('/api/getPages').then(function (response) {
      _this.pages = response.data; // console.log(this.pages)
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios.get('/api/getMotto').then(function (response) {
      _this.motto = response.data;
    })["catch"](function (error) {
      return console.log(error);
    });
    axios.get('/api/getSubMotto').then(function (response) {
      _this.subMotto = response.data; // console.log(response.data);
    })["catch"](function (error) {
      return console.log(error);
    });
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    executeRecaptcha: function executeRecaptcha() {
      this.$refs.recaptcha.execute(); // this.bus.$emit('execute')
    },
    send: function send(recaptchaToken) {
      var _this = this;
      ...
      if (this.message != null || this.email != null || this.name != null) {
        axios.post('/api/sendMail', {
          ...
          if (response.data == 'ok') {
            if (!_this.rtl) {
              _this.error = 'email sent successfully';
            } else {
              _this.error = 'ایمیل ارسال شد';
            }

            _this.errorColor = 'green';
          } else if (response.data == 'nok0') {
            if (!_this.rtl) {
              _this.error = 'email is not valid';
            } else {
              _this.error = 'ایمیل وارد شده معتبر نیست';
            }
            ...
            if (!_this.rtl) {
              ...
              _this.error = 'تمامی فیلد ها اجباری هستند';
            }
            ...
            if (!_this.rtl) {
              _this.error = 'server error: Email not sent!';
            } else {
              _this.error = 'ارور سرور : ایمیل ارسال نشد!';
            }
          ...
          console.error(error);
          _this.error = error + "<br>try again later";
          _this.errorColor = 'red';
        });
      } else {
        this.errorColor = 'red';
  ...
  mounted: function mounted() {
    ...
    axios.get('/api/getPhone').then(function (response) {
      _this2.contactPhone = response.data[0].value.en;
      _this2.contactPhoneFa = response.data[0].value.fa_IR;
    })["catch"](function (error) {
      return console.log(error);
    });
    axios.get('/api/getEmail').then(function (response) {
      _this2.contactEmail = response.data[0].value.en;
    })["catch"](function (error) {
      return console.log(error);
    });
    axios.get('/api/getAddress').then(function (response) {
      _this2.contactAddresss = response.data[0].value.en; // console.log(response.data[0].value.en);

      _this2.contactAddresssFa = response.data[0].value.fa_IR;
    })["catch"](function (error) {
      return console.log(error);
    });
  }
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/pages/Footerr.vue?vue&type=script&lang=js&":
/*!************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/pages/Footerr.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  mounted: function mounted() {
    ...
    axios.get('/api/footer').then(function (response) {
      ...
      if (_this.articles.length == 1) {
        _this.columns = "w3-rest";
      } else if (_this.articles.length == 2) {
        _this.columns = "w3-half";
      } else if (_this.articles.length == 3) {
        _this.columns = "w3-third";
      } else if (_this.articles.length == 0) {
        _this.columns = 0;
      }
    })["catch"](function (error) {
      return console.log(error);
...
/*!************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--5-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--5-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Layout.vue?vue&type=style&index=0&lang=css& ***!
  \************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n.router-link-active[data-v-6dde423b] {\n    background-color: #009688 !important;\n    font-weight: bold;\n    text-decoration: none;\n    /*word-wrap: break-word;*/\n}\n.select-css[data-v-6dde423b] {\n    /*display: inline-block;*/\n    /*font-family: sans-serif;*/\n    /*font-weight: 700;*/\n    color: #444 !important;\n    line-height: 1.3;\n    padding: 2px 30px 2px 5px;\n    width: inherit;\n    /*height: 100%;*/\n    /*max-width: 100%;*/\n    box-sizing: border-box;\n    /*margin: 0;*/\n    border: 1px solid #aaa;\n    /*box-shadow: 0 1px 0 1px rgba(0,0,0,.04);*/\n    border-radius: .5em;\n    -moz-appearance: none;\n    -webkit-appearance: none;\n    appearance: none;\n    background-color: #fff;\n    background-image: url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%22292.4%22%20height%3D%22292.4%22%3E%3Cpath%20fill%3D%22%23007CB2%22%20d%3D%22M287%2069.4a17.6%2017.6%200%200%200-13-5.4H18.4c-5%200-9.3%201.8-12.9%205.4A17.6%2017.6%200%200%200%200%2082.2c0%205%201.8%209.3%205.4%2012.9l128%20127.9c3.6%203.6%207.8%205.4%2012.8%205.4s9.2-1.8%2012.8-5.4L287%2095c3.5-3.5%205.4-7.8%205.4-12.8%200-5-1.9-9.2-5.5-12.8z%22%2F%3E%3C%2Fsvg%3E'),\n    linear-gradient(to bottom, #ffffff 0%, #ffffff 100%);\n    background-repeat: no-repeat, repeat;\n    background-position: right .7em top 50%, 0 0;\n    background-size: .65em auto, 100%;\n}\n.select-css[data-v-6dde423b]::-ms-expand {\n    display: none;\n}\n.select-css[data-v-6dde423b]:hover {\n    border-color: #888;\n}\n.select-css[data-v-6dde423b]:focus {\n    border-color: #aaa;\n    box-shadow: 0 0 1px 3px rgba(59, 153, 252, .7);\n    box-shadow: 0 0 0 3px -moz-mac-focusring;\n    color: #222;\n    outline: none;\n}\n.select-css option[data-v-6dde423b] {\n    font-weight: normal;\n}\n.navtext[data-v-6dde423b] {\n    font-weight: bold;\n    text-align: center;\n    color: white;\n    text-decoration: none;\n    vertical-align: middle;\n    height: 60px;\n    padding: 6% 3%;\n}\n@media screen and (max-width: 1000px) {\n\n    /*a,*{*/\n        /*font-size: 1.12em!important;*/\n    /*}*/\n.router-link-active[data-v-6dde423b] {\n        background-color: transparent !important;\n        color: #009688 !important;\n        /*font-size: 34px;*/\n}\n.mobilePadding[data-v-6dde423b] {\n        padding: 2.5%;\n}\n.mobileRtlMargin[data-v-6dde423b] {\n        margin-right: 12%;\n}\n.mobileLtrMargin[data-v-6dde423b] {\n        margin-left: 12%;\n}\n}\n", ""]);
...
/*!*************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--5-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--5-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Sidebar.vue?vue&type=style&index=0&id=81fbb27e&scoped=true&lang=css& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n.w3-bar-block .w3-dropdown-hover .w3-dropdown-content[data-v-81fbb27e], .w3-bar-block .w3-dropdown-click .w3-dropdown-content[data-v-81fbb27e] {\n    width: 100%;\n    min-width: auto !important;\n}\n.router-link-active[data-v-81fbb27e] {\n    color: #009688;\n    font-weight: bold;\n    text-decoration: none\n}\na[data-v-81fbb27e] {\n    color: #000;\n    text-decoration: none\n}\n.rtlLogo[data-v-81fbb27e] {\n    width: 50%;\n    margin-right: 25%\n}\n.ltrLogo[data-v-81fbb27e] {\n    width: 50%;\n    margin-left: 25%\n}\n.moto[data-v-81fbb27e] {\n    font-size: 0.9em;\n}\n.subMoto[data-v-81fbb27e] {\n    font-size: 0.85em;\n}\n/* On smaller screens, where height is less than 450px, change the style of the sidenav (less padding and a smaller font size) */\n@media screen and (max-width: 1000px) {\n.moto[data-v-81fbb27e] {\n        font-size: 1.1em;\n}\n.subMoto[data-v-81fbb27e] {\n        font-size: 1em;\n}\n.sidebar[data-v-81fbb27e] {\n        padding-top: 1px;\n}\n}\n\n\n", ""]);
...
/*!****************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/style-loader!./node_modules/css-loader??ref--5-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--5-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Layout.vue?vue&type=style&index=0&lang=css& ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/style-loader!./node_modules/css-loader??ref--5-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--5-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Sidebar.vue?vue&type=style&index=0&id=81fbb27e&scoped=true&lang=css& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"9cdd6cc0-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Menu.vue?vue&type=template&id=6fc94ece&
...
var Menuvue_type_template_id_6fc94ece_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Menu.vue?vue&type=template&id=6fc94ece&
...
var component = normalizeComponent(
  ...
  Menuvue_type_template_id_6fc94ece_render,
  Menuvue_type_template_id_6fc94ece_staticRenderFns,
  false,
  null,
  null,
  null
...
var render = function() {
  ...
  return _c("div", { staticClass: "container", attrs: { dir: _vm.dir } }, [
    _c(
      "div",
      { staticClass: "row" },
      [
        _vm.sidebarToggleBtn && !_vm.rtl
          ? _c(
              "Slide",
              {
    ...
    _vm._v(" "),
    _c("div", { class: { content: !_vm.rtl, rtlContent: _vm.rtl } }, [
      _c("div", { staticClass: "row" }, [_c("navbar")], 1),
      _vm._v(" "),
      _c(
        "div",
        { staticClass: "row" },
        [
          ...
          _c("vue-progress-bar"),
          _vm._v(" "),
          _c("footerr", { staticClass: "w3-animate-opacity" })
        ],
        1
      )
    ])
...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "w3-row w3-large mobilePadding",
      class: { mobileRtlMargin: _vm.rtl, mobileLtrMargin: !_vm.rtl },
      staticStyle: { "background-color": "#605e8b!important" }
    },
    [
      _vm._l(_vm.pages, function(page) {
        return page.template == "menus"
          ? _c(
              "div",
              {
                staticClass: "w3-col m6 l3 s6 w3-rtl ",
                style: { float: _vm.menuAlign }
              },
              [
                !_vm.rtl
                  ? _c(
                      "router-link",
                      {
                        staticClass: "w3-block navtext",
                        attrs: {
                          to: "/" + _vm.$i18n.locale + "/page/" + page.slug
                        }
                      },
                      [
                        _vm._v(
                          "\n\n            " +
                            _vm._s(page.title.en) +
                            "\n\n        "
                        )
                      ]
                    )
          ...
          _c("div", { staticClass: "navtext" }, [
            !_vm.rtl
              ? _c("img", {
                  ...
                  class: { rtlLogo: _vm.rtl, ltrLogo: !_vm.rtl },
                  attrs: {
                    src: __webpack_require__(/*! ../../assets/images/uk.png */ "./resources/assets/images/uk.png"),
                    alt: "uk"
                  }
                })
              : _c("img", {
                  ...
                  class: { rtlLogo: _vm.rtl, ltrLogo: !_vm.rtl },
                  attrs: {
                    src: __webpack_require__(/*! ../../assets/images/ir.png */ "./resources/assets/images/ir.png"),
                    alt: "iran"
                  }
                }),
            _vm._v(" "),
...
var render = function() {
  ...
  return _c("div", [
    _c(
      "div",
      {
        staticClass: "w3-collapse w3-white w3-animate-left",
        staticStyle: { width: "100%!important", overflow: "hidden" }
      },
      [
        _c("router-link", { attrs: { to: "/" + _vm.$i18n.locale + "/home" } }, [
          _c("img", {
            staticClass: "w3-round",
            class: { rtlLogo: _vm.rtl, ltrLogo: !_vm.rtl },
            attrs: { src: __webpack_require__(/*! ../../assets/images/logo.gif */ "./resources/assets/images/logo.gif"), alt: "logo" }
          }),
          _c("br"),
          _c("br")
        ]),
        _vm._v(" "),
        _vm._l(_vm.motto, function(motto) {
          return _c("div", { staticClass: "moto" }, [
            !_vm.rtl
              ? _c("b", [_vm._v(_vm._s(motto.value.en))])
              : _c("b", [_vm._v(_vm._s(motto.value.fa_IR))])
          ])
        }),
        _vm._v(" "),
        _vm._l(_vm.subMotto, function(subMotto) {
          return _c("div", { staticClass: "subMoto" }, [
            !_vm.rtl
              ? _c("p", { staticClass: "w3-text-grey" }, [
                  _vm._v(
                    "\n                " +
                      _vm._s(subMotto.value.en) +
                      "\n            "
                  )
                ])
              : _c("p", { staticClass: "w3-text-grey" }, [
        ...
        _c(
          ...
          [
              ...
              _c(
                ...
                [
                  _c(
                    "router-link",
                    {
                      staticClass: "w3-bar-item w3-padding",
                      staticStyle: { "text-decoration": "none" },
                      style: { "text-align": _vm.menuAlign },
                      attrs: {
                        to: "/" + _vm.$i18n.locale + "/home",
                        routerLinkActive: "router-link-active"
                      }
                    },
                    [
                      _c("i", {
                        staticClass: "fa fa-home fa-fw w3-margin-right"
                      }),
                      _vm._v(" "),
                      _vm.rtl
                        ? _c(
            ...
            _vm._l(_vm.categories, function(category) {
              return category.name.en != "Footer" &&
                category.name.en != "Slides"
                ? _c("div", [
                    category.slug == "students"
                      ? _c(
                          "div",
                          [
                            _c(
                              ...
                              [
                                _c("i", {
                                  class:
                                    "fa fa-fw w3-margin-right " + category.icon
                                }),
                                _vm._v(" "),
                                _vm.rtl
                                  ? _c(
                              ...
                              [
                                ...
                                _vm.rtl
                                  ? _c(
                                      ...
                                      [_vm._v(_vm._s(category.name.fa_IR))]
                                    )
                                  : _c(
                                      "div",
                                      {
                                      ...
                                      [_vm._v(_vm._s(category.name.en))]
                                    )
                              ]
                            )
                          ],
            ...
            [
              _c(
                "router-link",
                {
                  ...
                  style: { "text-align": _vm.menuAlign },
                  attrs: {
                    to: "/" + _vm.$i18n.locale + "/contact-us",
                    routerLinkActive: "router-link-active"
                  }
                },
                [
                  _c("i", {
                    staticClass: "fa fa-envelope-o fa-fw w3-margin-right"
                  }),
                  _vm._v(" "),
                  _vm.rtl
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "w3-padding-large w3-light-grey" }, [
    !_vm.rtl
      ? _c("h4", [_c("b", [_vm._v("Contact Us")])])
      : _c("h4", [_c("b", [_vm._v("تماس با ما")])]),
    _vm._v(" "),
    _c(
      "div",
      {
        staticClass: "w3-row-padding w3-center w3-padding-24",
        staticStyle: { margin: "0 -16px" }
      },
      [
        _c("div", { staticClass: "w3-third w3-dark-grey" }, [
          _vm._m(0),
          _vm._v(" "),
          _c("p", [_vm._v(_vm._s(_vm.contactEmail))])
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "w3-third w3-teal" }, [
          _vm._m(1),
          _vm._v(" "),
          !_vm.rtl
            ? _c("p", [_vm._v(_vm._s(_vm.contactAddresss))])
            : _c("p", [_vm._v(_vm._s(_vm.contactAddresssFa))])
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "w3-third w3-dark-grey" }, [
          _vm._m(2),
          _vm._v(" "),
          !_vm.rtl
            ? _c("p", [_vm._v(_vm._s(_vm.contactPhone))])
            : _c("p", [_vm._v(_vm._s(_vm.contactPhoneFa))])
        ])
      ]
    ),
    _vm._v(" "),
    _c("hr", { staticClass: "w3-opacity" }),
    _vm._v(" "),
    _c(
      "div",
      [
        _c("div", { staticClass: "w3-section" }, [
          !_vm.rtl
            ...
            : _c("label", [_vm._v("نام و نام خانوادگی")]),
          _vm._v(" "),
          _c("input", {
            directives: [
              {
        ...
        _c("div", { staticClass: "w3-section" }, [
          ...
          _c("textarea", {
            ...
            staticClass: "w3-input w3-border",
            attrs: { type: "text", name: "mesage", rows: "5", required: "" },
        ...
        _vm._v(" "),
        _c("div", { style: { color: _vm.errorColor } }, [
          _vm._v("\n            " + _vm._s(_vm.error) + "\n        ")
        ]),
        _vm._v(" "),
        _c("vue-recaptcha", {
          ...
          on: { verify: _vm.send, expired: _vm.onCaptchaExpired }
        }),
        _vm._v(" "),
        _vm.errorColor != "green"
          ? _c(
              "button",
              {
                staticClass: "w3-button w3-black w3-margin-bottom",
                on: { click: _vm.executeRecaptcha }
              },
              [
                _c("i", { staticClass: "fa fa-paper-plane w3-margin-right" }),
                _vm._v(" "),
                !_vm.rtl
                  ? _c("div", { staticStyle: { display: "inline-block" } }, [
                      _vm._v("\n                Send Message\n            ")
...
var staticRenderFns = [
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("p", [
      _c("i", { staticClass: "fa fa-envelope w3-xxlarge w3-text-light-grey" })
    ])
  },
  function() {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("p", [
      _c("i", { staticClass: "fa fa-map-marker w3-xxlarge w3-text-light-grey" })
    ])
  },
  function() {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("p", [
      _c("i", { staticClass: "fa fa-phone w3-xxlarge w3-text-light-grey" })
    ])
  }
]
render._withStripped = true
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/pages/Footerr.vue?vue&type=template&id=409f5491&scoped=true&":
/*!****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/pages/Footerr.vue?vue&type=template&id=409f5491&scoped=true& ***!
  \****************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm.columns != 0
    ? _c("div", { staticClass: "w3-container w3-padding-32 w3-dark-grey" }, [
        _c(
          "div",
          { staticClass: "w3-row-padding" },
          _vm._l(_vm.articles, function(article) {
            return _c("div", { class: _vm.columns }, [
              !_vm.rtl
                ? _c("div", {
                    domProps: { innerHTML: _vm._s(article.content.en) }
                  })
                : _c("div", {
                    domProps: { innerHTML: _vm._s(article.content.fa_IR) }
                  })
            ])
          }),
          0
...
/***/ "./resources/assets/images/ir.png":
/*!****************************************!*\
  !*** ./resources/assets/images/ir.png ***!
  \****************************************/
/*! no static exports found */
...
module.exports = "/images/ir.png?5dac483a6d91839a8973dfe30ea08de4";

/***/ }),

/***/ "./resources/assets/images/logo.gif":
/*!******************************************!*\
  !*** ./resources/assets/images/logo.gif ***!
  \******************************************/
/*! no static exports found */
...
module.exports = "/images/logo.gif?fd5a649a410caf1c0e3aaaae235dc038";

/***/ }),

/***/ "./resources/assets/images/uk.png":
/*!****************************************!*\
  !*** ./resources/assets/images/uk.png ***!
  \****************************************/
/*! no static exports found */
...
module.exports = "/images/uk.png?ec31660c379821f3db808567c606b3dc";
...
window.Vue = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.common.js"); // use beforeEach route guard to set the language
...
_router__WEBPACK_IMPORTED_MODULE_2__["default"].beforeEach(function (to, from, next) {
  ...
  _i18n__WEBPACK_IMPORTED_MODULE_3__["default"].locale = language;
  next();
});
/**
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_5_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_5_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Sidebar_vue_vue_type_style_index_0_id_81fbb27e_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/style-loader!../../../node_modules/css-loader??ref--5-1!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/src??ref--5-2!../../../node_modules/vue-loader/lib??vue-loader-options!./Sidebar.vue?vue&type=style&index=0&id=81fbb27e&scoped=true&lang=css& */ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Sidebar.vue?vue&type=style&index=0&id=81fbb27e&scoped=true&lang=css&");
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_5_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_5_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Sidebar_vue_vue_type_style_index_0_id_81fbb27e_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_5_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_5_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Sidebar_vue_vue_type_style_index_0_id_81fbb27e_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_5_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_5_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Sidebar_vue_vue_type_style_index_0_id_81fbb27e_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_5_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_5_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Sidebar_vue_vue_type_style_index_0_id_81fbb27e_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_5_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_5_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Sidebar_vue_vue_type_style_index_0_id_81fbb27e_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/***/ "./resources/js/components/pages/Footerr.vue":
/*!***************************************************!*\
  !*** ./resources/js/components/pages/Footerr.vue ***!
  \***************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Footerr_vue_vue_type_template_id_409f5491_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Footerr.vue?vue&type=template&id=409f5491&scoped=true& */ "./resources/js/components/pages/Footerr.vue?vue&type=template&id=409f5491&scoped=true&");
/* harmony import */ var _Footerr_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Footerr.vue?vue&type=script&lang=js& */ "./resources/js/components/pages/Footerr.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Footerr_vue_vue_type_template_id_409f5491_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Footerr_vue_vue_type_template_id_409f5491_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  "409f5491",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/pages/Footerr.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/pages/Footerr.vue?vue&type=script&lang=js&":
/*!****************************************************************************!*\
  !*** ./resources/js/components/pages/Footerr.vue?vue&type=script&lang=js& ***!
  \****************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Footerr_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib??ref--4-0!../../../../node_modules/vue-loader/lib??vue-loader-options!./Footerr.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/pages/Footerr.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Footerr_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/pages/Footerr.vue?vue&type=template&id=409f5491&scoped=true&":
/*!**********************************************************************************************!*\
  !*** ./resources/js/components/pages/Footerr.vue?vue&type=template&id=409f5491&scoped=true& ***!
  \**********************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Footerr_vue_vue_type_template_id_409f5491_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./Footerr.vue?vue&type=template&id=409f5491&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/pages/Footerr.vue?vue&type=template&id=409f5491&scoped=true&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Footerr_vue_vue_type_template_id_409f5491_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Footerr_vue_vue_type_template_id_409f5491_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
/* harmony default export */ __webpack_exports__["default"] = (new vue_i18n__WEBPACK_IMPORTED_MODULE_1__["default"]({
  locale: 'en',
  fallbackLocale: 'en' // messages: loadLocaleMessages()
...
var Contact = function Contact() {
  return Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./components/pages/Contact */ "./resources/js/components/pages/Contact.vue"));
};

var Home = function Home() {
  return Promise.all(/*! import() */[__webpack_require__.e(6), __webpack_require__.e(0), __webpack_require__.e(3)]).then(__webpack_require__.bind(null, /*! ./components/pages/Home */ "./resources/js/components/pages/Home.vue"));
};

var Category = function Category() {
  return Promise.all(/*! import() */[__webpack_require__.e(1), __webpack_require__.e(0), __webpack_require__.e(2)]).then(__webpack_require__.bind(null, /*! ./components/pages/Category */ "./resources/js/components/pages/Category.vue"));
};

var Page = function Page() {
  return __webpack_require__.e(/*! import() */ 5).then(__webpack_require__.bind(null, /*! ./components/pages/Page */ "./resources/js/components/pages/Page.vue"));
};

var Students = function Students() {
  return __webpack_require__.e(/*! import() */ 4).then(__webpack_require__.bind(null, /*! ./components/pages/Students */ "./resources/js/components/pages/Students.vue"));
};

var Content = function Content() {
  return __webpack_require__.e(/*! import() */ 0).then(__webpack_require__.bind(null, /*! ./components/pages/Content */ "./resources/js/components/pages/Content.vue"));
};
...
/* harmony default export */ __webpack_exports__["default"] = (new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  routes: [{
    path: '/',
    redirect: "".concat(_i18n__WEBPACK_IMPORTED_MODULE_2__["default"].locale, "/home"),
    meta: {
      progress: {
        func: [{
          call: 'color',
...
module.exports = __webpack_require__(/*! C:\wamp64\www\biofuildsLab\resources\js\app.js */"./resources/js/app.js");
